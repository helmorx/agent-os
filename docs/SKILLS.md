...
HELMOR Agent OS ships with 14 built-in skills. They help AI coding agents choose the right behavior before spending tokens, editing code, running checks, or closing out a task.
