class Helmor < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/helmorx/agent-os/releases/download/v0.1.0/helmor_darwin_arm64.tar.gz"
      sha256 "85ad2f1e948379c344da0f5963aee78cf57ab3b07ed915362436ee723462b749"
    else
      url "https://github.com/helmorx/agent-os/releases/download/v0.1.0/helmor_darwin_amd64.tar.gz"
